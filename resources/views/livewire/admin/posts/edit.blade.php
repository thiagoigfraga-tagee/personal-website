        ...
        <div class="max-w-4xl mx-auto px-6 py-12">
            ...
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-4xl font-bold text-white">Editar Post</h1>
                </div>
                <p class="text-zinc-400 font-mono">{{ $post->title }}</p>
            </div>
            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <div>
                    ...
                    <div wire:ignore>
                        <textarea id="content" wire:model="content" x-data="{
                            editor: null,
                            init() {
                                const initEditor = () => {
                                    if (window.EasyMDE) {
