<x-layouts.admin>
    ...
    <div class="min-h-screen bg-zinc-900 text-zinc-100">
        <div class="max-w-7xl mx-auto px-6 py-12">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                ...
                <div class="p-6 bg-zinc-800 border border-zinc-700 rounded-lg">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-sm font-semibold text-zinc-500 uppercase">{{ __('messages.total_posts') }}</h3>
                ...
                <div class="p-6 bg-zinc-800 border border-zinc-700 rounded-lg">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-sm font-semibold text-zinc-500 uppercase">{{ __('messages.published_posts') }}
                        </h3>
                ...
                <div class="p-6 bg-zinc-800 border border-zinc-700 rounded-lg">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-sm font-semibold text-zinc-500 uppercase">{{ __('messages.draft_posts') }}</h3>
                ...
                <div class="p-6 bg-zinc-800 border border-zinc-700 rounded-lg">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-sm font-semibold text-zinc-500 uppercase">{{ __('messages.total_tags') }}</h3>
            ...
            <!-- Quick Actions -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-white mb-6">{{ __('messages.quick_actions') }}</h2>
